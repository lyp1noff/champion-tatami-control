  ...
  return (
    <div className="w-screen h-screen bg-black text-white p-8 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 text-right">
        ...
        <div className="text-sm text-gray-400">TATAMI CONTROL</div>
      </div>
      ...
      <div className="flex justify-between items-end text-center relative z-10">
        ...
        <div className="flex-1">
          ...
          <div className="text-xl text-gray-300 mb-1">
            {athlete1 ? `${athlete1.first_name} ${athlete1.last_name}` : "FIGHTER 1"}
          </div>
          {renderDots(shido1)}
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="text-xl text-gray-300 mb-1">
            {athlete2 ? `${athlete2.first_name} ${athlete2.last_name}` : "FIGHTER 2"}
          </div>
          {renderDots(shido2)}
        </div>
      </div>
      ...
      {/* Connection Status */}
      <div className="absolute bottom-4 left-4 text-sm text-gray-500">Connected via BroadcastChannel</div>
    </div>
  );
}
